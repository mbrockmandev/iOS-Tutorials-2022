...
let beachBallOptions: UIView.AnimationOptions = [.curveEaseIn, .repeat, .autoreverse]
let drinkOptions: UIView.AnimationOptions = [.curveEaseOut, .repeat, .autoreverse]
let iceCreamOptions: UIView.AnimationOptions = [.curveLinear, .repeat, .autoreverse]
