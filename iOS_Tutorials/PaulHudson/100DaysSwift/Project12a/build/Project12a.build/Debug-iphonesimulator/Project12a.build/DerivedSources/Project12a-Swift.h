...
#ifndef PROJECT12A_SWIFT_H
#define PROJECT12A_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Project12a",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Project12a11AppDelegate")
...
SWIFT_CLASS("_TtC10Project12a6Person")
...
SWIFT_CLASS("_TtC10Project12a10PersonCell")
...
SWIFT_CLASS("_TtC10Project12a13SceneDelegate")
...
SWIFT_CLASS("_TtC10Project12a14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Project12a)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
